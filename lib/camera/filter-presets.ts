export interface FilterPreset {
  id: string;
  label: string;
  /** Client preview + capture (CSS filter string) */
  css: string;
  /** Server-side sharp transforms — applied in media/bake function */
  sharp?: {
...
/** @deprecated Use FILTER_PRESETS */
export const CAPTURE_FILTERS = FILTER_PRESETS;
